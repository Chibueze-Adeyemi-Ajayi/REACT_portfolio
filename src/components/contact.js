const Card = (props) => {
    return (
        <div className="w-full h-fit p-6 flex flex-row space-x-0 border rounded-md border-white/30">
            {props.icon ? <div className="flex w-[3.8rem] h-14 bg-white/30 my-auto rounded-full">{props.icon}</div> : <></>}
...
const Contact = () => {
    return (
        <div id="contact" className="w-full h-full p-6">
            ...
            <section className="w-full md:p-6 h-full grid md:grid-cols-2 gap-6">
                <Card icon={
                ...
                } title="Address" content={<div className="pt-[0.73rem]">
                    <font>CPSF Lodge, Behind Equity Hostel, Peace Avenue, FUTA South-Gate, Akure, Ondo-State</font>
                </div>} />
                <Card title="Social Profiles" content={
                    <div className="w-fit mx-auto h-fit grid grid-cols-4 pt-4 gap-8">
                ...
                <Card title="Quick Actions" content={<div className="pt-[0.73rem] flex space-x-4">
                    <a className="underline text-green-600" href="https://wa.me/+2348131869009">Whatsapp Me</a>
                    <a className="underline text-blue-600" href="tel:+2348131869009">Call Me</a>
                    <a className="underline text-red-400" href="mailto:chibuezeadeyemi@gmail.com">Email Me</a>
                </div>} />
                <div className="w-full items-center h-fit p-6 flex flex-row space-x-4 border rounded-md border-white/30">
                    <font className="md:text-6xl text-4xl font-bold text-white/90">Thank you</font>
                    <svg className="w-14 my-auto h-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                        <path className="fill-yellow-400" d="M0 256c0 137 111 248 248 248s248-111 248-248S385 8 248 8 0 119 0 256zm200-48c0 17.7-14.3 32-32 32s-32-14.3-32-32 14.3-32 32-32 32 14.3 32 32zm158.5 16.5c-14.8-13.2-46.2-13.2-61 0L288 233c-8.3 7.4-21.6.4-19.8-10.8 4-25.2 34.2-42.1 59.9-42.1S384 197 388 222.2c1.7 11.1-11.4 18.3-19.8 10.8l-9.7-8.5zM157.8 325.8C180.2 352.7 213 368 248 368s67.8-15.4 90.2-42.2c13.6-16.2 38.1 4.2 24.6 20.5C334.3 380.4 292.5 400 248 400s-86.3-19.6-114.8-53.8c-13.5-16.3 11.2-36.7 24.6-20.4z"/>
                    </svg>
                </div>
            </section>
        </div>  
