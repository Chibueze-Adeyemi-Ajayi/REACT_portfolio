    ...
    return (
        <div className="w-full h-full p-6">
            ...
            <section className="w-full p-6 h-full grid grid-cols-2 gap-6">
                ...
                <Card title="Quick Actions" content={<div className="pt-[0.73rem]">
                    <a href="https://api.whatsapp.com/send?phone=+2348131869009">Whatsapp Me</a>
                    <a href="tel:+2348131869009">Whatsapp Me</a>
                    <a href="mailto:chibuezeadeyemi@gmail.com">Whatsapp Me</a>
                </div>} />
            </section>
        </div>  
    );
