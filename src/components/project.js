    ...
    return (//return widget
        <div className="w-full h-fit space-y-2 flex flex-col p-3 border border-white/20 rounded-lg">
            ...
            <div className="w-full h-fit flex flex-row space-x-4">
                ...
                {props.code ? <a className="w-fit flex space-x-3" href={props.source_code} target="_blank">
        ...
        <scetion id="project" className="w-full h-full p-6 flex md:flex-row flex-col md:space-x-4">
            ...
            <section className="w-full md:mt-0 mt-2 flex flex-col h-full border-l border-white/30">
                ...
                <div className="w-full h-full md:p-6 p-3 grid md:grid-cols-2 gap-6">
                    <Card code={false} active={true} link="https://store.5iyori.com/" source_code="" language="PHP(Laravel) & JavaScript" color="bg-purple-500" title="5iyori - Store (e-commerce)" content="From amazing shopping experience to - blog, order, product and customer management system (Admin Panel) based on order of prviledge for the case of organizational use." />
                    <Card code={false} active={true} link="https://5iyori.com/" source_code="" language="JavaScript(REACT)" color="bg-yellow-300" title="5iyori" content="Frontend web application built for a gaming startup in Nigeria, 5iyori integrated service. The website was developed using JS REACT frontend framework" />
                    <Card code={false} active={true} link="https://trava.netlify.app/" source_code="" language="HTML/CSS(TailwindCSS)" color="bg-cyan-800" title="Trava" content="Landing page website designed for a client in the United States of America. The website communicates the entire features of the delivery app." />
                    <Card code={false} active={true} link="https://insidefutmx.ng/" source_code="" language="PHP(Laravel) & JavaScript" color="bg-purple-500" title="Blog/Market Website" content="Portal for students in Federal University of Technology, Minna, Niger State, Nigeria. For sharing academic resorces, daily news update also a marketplace to buy and sell on a level 1 structure." />
                    <Card code={false} active={true} link="https://cvsexpertsbuilders.com/" source_code="" language="PHP(Laravel) & JavaScript" color="bg-purple-500" title="CV Building Website" content="Fullstack web application built for a CV designing firm in United Kingdom. Entire application was built using the standard monolith architecture." />
                    <Card code={false} active={true} link="https://workspace.t21services.co.uk" source_code="https://github.com/Chibueze-Adeyemi-Ajayi/ReactChatSystem" language="PHP(Laravel) & JavaScript(REACT)" color="bg-blue-600" title="Workspace" content="This web application serves the purpose of a company's workspace. Built the entire RESTful API following microservice architecture" />
                    <Card code={true} active={false} source_code="https://github.com/Crediometer/credio_ajo" language="Dart(Flutter)" color="bg-cyan-300" title="Credio Ajo App" content="Fully fledge contribution (ajo) mobile/desktop app was worked upon with my team during the days of my internship with crediometer. Flutter was the framework used to achieve this." />
                    <Card code={true} active={true} link="https://language-processor.netlify.app/" source_code="https://github.com/Chibueze-Adeyemi-Ajayi/LanguageProcessor" language="Dart(Flutter)" color="bg-cyan-300" title="Language Processor" content="A machine learning mobile application, which makes use of Natural Language Processing to understand human language then translate it to any choosen language" />
                    <Card code={true} active={true} link="https://up-project.netlify.app/" source_code="https://github.com/Chibueze-Adeyemi-Ajayi/dapp_minting" language="JavaScript" color="bg-yellow-300" title="ERC20 Token Minting" content="A web3 based web applications, which connects to the Ethereum blockchain via Metamask. The main purpose of the app is for minting tokens over the blockchain" />
                    <Card code={true} active={false} source_code="https://github.com/Chibueze-Adeyemi-Ajayi/php-ussd" language="Php" color="bg-blue-900" title="USSD Application" content="A simple Unstructured Supplementary Service Data (USSD) application built with PHP. The application has been deployed to the sandwish africastalking testnet" />
                    <Card code={true} active={false} source_code="https://github.com/Chibueze-Adeyemi-Ajayi/cam-AI" language="C++" color="bg-pink-500" title="CAM AI" content="A flutter mobile application, which harnesses the power of computer vision to recognises texts, scan barcodes, also detect several pody position during a pose detection mode." />
                </div>
