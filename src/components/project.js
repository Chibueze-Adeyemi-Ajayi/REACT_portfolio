        ...
        <scetion className="w-full h-full p-6 flex space-x-4">
            ...
            <section className="w-full h-full border-l border-white/30">
                ...
                <div className="w-full h-full p-6 grid grid-cols-2 gap-6">
                    ...
                    <Card active={true} link="https://up-project.netlify.app/" source_code="https://github.com/Chibueze-Adeyemi-Ajayi/dapp_minting" language="JavaScript" color="bg-yellow-300" title="Blockchain Minting" content="A web3 based web applications, which connects to the Ethereum blockchain via Metamask. The main purpose of the app is for minting tokens over the blockchain" />
