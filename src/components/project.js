        ...
        <scetion className="w-full h-full p-6 flex">
            <section className="lg:w-[500px] md:w-[400px] h-fit my-auto flex flex-col space-y-8">
                <div className="w-full h-fit my-auto flex flex-col space-y-5">
                    <svg className="w-64 h-64 mx-auto my-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                    ...
                    <a target="_blank" href="https://github.com/Chibueze-Adeyemi-Ajayi" className="w-full h-10 text-white/90 font-extrabold text-center pt-2 border border-white/30 rounded-md">View my `1K+ contributions on Github</a>
                </div>
            </section>
